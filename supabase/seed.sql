-- ============================================================
-- Africa Property Finder — Complete Seed Data
-- All tables: auth.users, profiles, properties, blogs,
--   contacts, appointments, savedProperties, attendance,
--   crime_stations
-- ============================================================

-- ============================================================
-- 1. AUTH USERS & PROFILES
-- Insert into auth.users first; the on_auth_user_created trigger
-- creates the profile row, then we UPDATE with extra fields.
...
-- Cities match crime_stations for safety badge integration
-- ============================================================
