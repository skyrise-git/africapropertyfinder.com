  ...
  return (
    <section className="w-full max-w-full overflow-x-hidden">
      <div className="container mx-auto max-w-7xl px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16 w-full">
        ...
        >
          <h2 className="text-slate-700 dark:text-gray-100 mb-1.5 sm:mb-2 md:mb-3 lg:mb-4 text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light tracking-tight px-1 sm:px-2 break-words leading-tight">
